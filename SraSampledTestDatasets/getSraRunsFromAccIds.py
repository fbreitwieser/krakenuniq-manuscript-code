...
def parse_args_sraIdentifier():
    ...
    parser.add_argument('--identifiers', type=str, help = "A list of comma separated SRA identifiers e.g. SRP046206,SRX188939,SRS807544,SRR1759594,PRJNA63661",  required = False)
    parser.add_argument('--outStub', type=str, help = "An output stub for info and sra urls output files",  required = False, default = "out")
